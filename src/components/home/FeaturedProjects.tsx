            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  {/* Image */}
                  <div className={`relative aspect-video rounded-lg overflow-hidden bg-primary-200 dark:bg-accent-800 ${index % 2 === 1 ? 'md:order-2' : ''}`}>
                    <Image
                      src={project.image}
                      alt={project.title}
                      fill
                    ...
                    <div>
                      {project.liveUrl ? (
                        ...
                        >
                          ...
                          <HiExternalLink className="w-5 h-5 text-ink-muted dark:text-primary-400 group-hover/link:text-ink dark:group-hover/link:text-primary-100 transition-colors" />
                        </a>
                      ) : (
                        <h3 className="text-2xl md:text-3xl font-bold text-ink dark:text-primary-50">
                          {project.title}
                        </h3>
                      )}
                    </div>
